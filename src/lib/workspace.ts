...
export const workspaceModules: WorkspaceModule[] = [
  ...
  { id: "categories", label: "Categories", group: "Menu", icon: "□", description: "Organize menus into clear, service-ready categories.", href: "/workspace/categories", liveHref: "/admin/menu/categories", permission: PERMISSIONS.SETTINGS_MANAGE },
