...
export const workspaceModules: WorkspaceModule[] = [
  ...
  { id: "menu", label: "Menu", group: "Menu", icon: "≡", description: "Manage sellable menu items, prices, availability, and station assignment.", href: "/workspace/menu", permission: PERMISSIONS.POS_ACCESS },
  { id: "categories", label: "Categories", group: "Menu", icon: "□", description: "Organize menus into clear, service-ready categories.", href: "/workspace/categories", permission: PERMISSIONS.POS_ACCESS },
  ...
  { id: "employees", label: "Employees", group: "People", icon: "◎", description: "Manage employee accounts, roles, and branch access.", href: "/workspace/employees", liveHref: "/admin/users", permission: PERMISSIONS.USERS_VIEW },
