...
export default async function CashierOrdersPage() {
  ...
  return (
    <main className="mx-auto max-w-7xl p-4 sm:p-6 lg:p-8">
      <PageHeading eyebrow="Cashier portal" title="Orders" description="Track the branch service queue, payment progress, and recent ticket details." actions={<Button href="/pos/register">Open register <span aria-hidden="true">→</span></Button>} />
      ...
      <Card className="mt-6 overflow-hidden">
        ...
        })}</div> : <div className="p-5"><EmptyState icon="◷" title="No branch orders yet" description="New, held, and completed tickets will appear here as they are created at the register." action={<Button href="/pos/register">Open register</Button>} /></div>}
      </Card>
    </main>
  );
}
