...
import { SUBSCRIPTION_PLAN_CODES, type PaidSubscriptionPlanCode, type SubscriptionPlanCatalog } from "@/lib/subscriptions";
...
export function SubscriptionClient({ currency, currentPlan, billingEmail, plans }: SubscriptionClientProps) {
  ...
  return (
    <>
      <section className="mt-6 grid gap-4 lg:grid-cols-3">
        {(SUBSCRIPTION_PLAN_CODES.filter((plan): plan is PaidSubscriptionPlanCode => plan !== "TRIAL")).map((plan) => {
